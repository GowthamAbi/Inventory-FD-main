    ...
    <div className="p-4">
          ...
          {/*New Item Name Image */}
            ...
            <div className='w-full flex'>
              ...
              <div className=' flex gap-4  pb-4'>
                    ...
                    <input type="text" className='w-1/2 outline-none border border-gray-300 p-1.5 rounded-lg ' />
              </div>
          ...
          <div className='full flex'>
            ...
            <div className='flex w-full pl-2 mb-4'>
              ...
              <div className='border border-gray-300 flex rounded-lg w-1/2 mx-2 '>
                ...
                <input className=' outline-none p-1' type="text" name="" id="" />
              </div>
            </div>
            ...
            <div className='flex w-full pl-2 mb-4'>
              <span className='w-2/6 '>Description</span>
                <textarea name="" id="" className='w-1/2 mx-2 rounded-lg border border-gray-300'></textarea>
          ...
          <div className='full flex'>
            ...
            <div className=' flex mb-4'>
              ...
              <input className='rounded-lg outline-none p-1 border border-gray-300 w-1/2' type="text" name="" id="" />
            </div>
          ...
          {/* Left */}
            ...
            <div className=' flex w-1/2  items-center'>
               <span className='w-2/6 '>Opening Stock</span>
              <input className='rounded-lg outline-none p-1 border h-10 border-gray-300 w-1/2' type="text" name="" id="" />
            </div>
